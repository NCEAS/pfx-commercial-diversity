...
for(cc in 1:length(casestudies)) {
  ...
  print(ggplot(temp,aes(x=year,y=fisheries)) + 
          geom_point() + 
          geom_line() + 
          ggtitle(paste("Number of unique permits held by holders of",casestudy,"permits")) + 
          theme_bw())
  ...
  print(ggplot(temp,aes(x=year,y=fisheries)) + 
          geom_point() + 
          geom_line() + 
          ggtitle(paste("Mean number of permits per holder of a",casestudy,"permit per year")) + 
          theme_bw())
  ...
  print(ggplot(p1,aes(x=year,y=fishers)) + 
          geom_point() + 
          geom_line() +
          ggtitle("Active permit holders per year") + 
          theme_bw())
  ...
  print(ggplot(p1,aes(x=year,y=rev)) + 
          geom_point() + 
          geom_line() + 
          ggtitle("Total gross revenues for the fishery per year") + 
          theme_bw())
